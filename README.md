...
Explanation
* Because Grabify links don't require user authentication to view their status (Broken Access Control Vulnerability), brute force algorithms can be used to guess the alphanumeric endpoints of the "track" subdirectory. This can expose ip addresses of users which can be used maliciously by attackers for various purposes such as DDOS, remote access, MITM attacks, network mapping, etc.
